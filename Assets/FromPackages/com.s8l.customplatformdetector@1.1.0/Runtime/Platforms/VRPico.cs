...
{
    public class VRPico : BasePlatform
#if UNITY_EDITOR
        , IBuildPlatform 
#endif
    {
        ...
        public static bool IsBuildPlatform()
        {
            ...
            return UnityEditor.EditorUserBuildSettings.activeBuildTarget == UnityEditor.BuildTarget.Android && loaders.Count > 0 && loaders[0].name.Contains("PXR");
        }
#endif
