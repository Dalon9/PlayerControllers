...
{
    public class WindowsPlayer : BasePlatform
#if UNITY_EDITOR
        , IBuildPlatform 
#endif
    {
        ...
        {
            return UnityEditor.EditorUserBuildSettings.activeBuildTarget == UnityEditor.BuildTarget.StandaloneWindows64 || UnityEditor.EditorUserBuildSettings.activeBuildTarget == UnityEditor.BuildTarget.StandaloneWindows;
        }
#endif       
