...
namespace VRTK
{
    ...
    public class VRTK_StraightPointerRenderer : VRTK_BasePointerRenderer
    {
        ...
        public string RayLayer = "Default";
        ...
        protected override void CreatePointerObjects()
        {
            ...
            //Custom code
            if (LayerMask.NameToLayer(RayLayer) >= 0)
                actualContainer.layer = LayerMask.NameToLayer(RayLayer);
        ...
        protected virtual void CreateTracer()
        {
            ...
            else
            {
                ...
                //Custom Code
                if (RayLayer == "Default" || LayerMask.NameToLayer(RayLayer) < 0)
                    actualTracer.layer = LayerMask.NameToLayer("Ignore Raycast");
                else
                    actualTracer.layer = LayerMask.NameToLayer(RayLayer);
        ...
        protected virtual void CreateCursor()
        {
            ...
            else
            {
                ...
                if (RayLayer == "Default" || LayerMask.NameToLayer(RayLayer) < 0)
                    ...
                    actualCursor.layer = LayerMask.NameToLayer(RayLayer);
        ...
        protected virtual float CastRayForward()
        {
            ...
            //Custom code
            bool rayHit = VRTK_CustomRaycast.Raycast(customRaycast, pointerRaycast, out pointerCollidedWith, RayLayer == "Default" || LayerMask.NameToLayer(RayLayer) < 0 ? (int)defaultIgnoreLayer : LayerMask.GetMask(RayLayer), maximumLength);
