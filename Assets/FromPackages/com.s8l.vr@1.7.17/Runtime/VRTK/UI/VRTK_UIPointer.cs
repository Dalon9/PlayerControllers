...
namespace VRTK
{
    ...
    public class VRTK_UIPointer : MonoBehaviour
    {
        ...
        [Tooltip(
            "An optional GameObject that determines what the pointer is to be attached to. If this is left blank then the GameObject the script is on will be used.")]
        public GameObject attachedTo;

        [Tooltip(
            "The Controller Events that will be used to toggle the pointer. If the script is being applied onto a controller then this parameter can be left blank as it will be auto populated by the controller the script is on at runtime.")]
        ...
        [System.Obsolete(
            "`VRTK_UIPointer.controller` has been replaced with `VRTK_UIPointer.controllerEvents`. This parameter will be removed in a future version of VRTK.")]
        [ObsoleteInspector]
        public VRTK_ControllerEvents controller;

        [System.Obsolete(
            "`VRTK_UIPointer.pointerOriginTransform` has been replaced with `VRTK_UIPointer.customOrigin`. This parameter will be removed in a future version of VRTK.")]
        [ObsoleteInspector]
        ...
        [HideInInspector] public GameObject controllerRenderModel;
        ...
        public virtual UIPointerEventArgs SetUIPointerEvent(RaycastResult currentRaycastResult,
        ...
        public virtual VRTK_VRInputModule SetEventSystem(EventSystem eventSystem)
        {
            if (eventSystem == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage(
                    VRTK_Logger.CommonMessageKeys.REQUIRED_COMPONENT_MISSING_FROM_SCENE, "VRTK_UIPointer",
                    "EventSystem"));
                return null;
            }
            ...
            {
                // S8l.VR 1.7.7: Creating new child eventsystem to counter [DisallowMultipleComponent].
                var newGameObject = new GameObject("VRTK_EventSystem");
                newGameObject.transform.SetParent(eventSystem.transform);
                eventSystem = newGameObject.AddComponent<VRTK_EventSystem>();
            }
        ...
        public virtual bool PointerActive()
        {
            ...
            else
            {
                ...
                lastPointerPressState =
                    (controllerEvents != null ? controllerEvents.IsButtonPressed(activationButton) : false);
...
#pragma warning disable 0618
            ...
            customOrigin = (pointerOriginTransform != null && customOrigin == null
                ? pointerOriginTransform
                : customOrigin);
#pragma warning restore 0618
            attachedTo = (attachedTo == null ? gameObject : attachedTo);
            controllerEvents = (controllerEvents != null
                ? controllerEvents
        ...
        protected virtual Transform GetPointerOriginTransform()
        {
            ...
            if (VRTK_ControllerReference.IsValid(controllerReference) &&
                (cachedAttachedHand != controllerReference.hand || cachedPointerAttachPoint == null))
            {
                cachedPointerAttachPoint = controllerReference.model.transform.Find(
                    VRTK_SDK_Bridge.GetControllerElementPath(SDK_BaseController.ControllerElements.AttachPoint,
                        controllerReference.hand));
