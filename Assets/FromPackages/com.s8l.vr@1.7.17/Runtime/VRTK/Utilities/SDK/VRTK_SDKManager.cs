...
namespace VRTK
{
    ...
    public sealed class VRTK_SDKManager : MonoBehaviour
    {
        ...
        {
            // TODO
            // THIS BIT OF CODE IS THE REASON FOR THE ENABLE XR ERROR PROMPT.
            // TODO            
...
//             }
        ...
        {
            // TODO: Cleanup the loading of the SDK Setups from the subsystem managers
...
#pragma warning restore 618
        ...
        private IEnumerator FinishSDKSetupLoading(VRTK_SDKSetup[] sdkSetups, VRTK_SDKSetup previousLoadedSetup)
        {
            ...
            if (loadedSetup.usedVRDeviceNames.Except(new[] { "None" }).Any())
            {
                ...
                XRDeviceUtility.StartDisplaySubsystems();
                yield return null;
