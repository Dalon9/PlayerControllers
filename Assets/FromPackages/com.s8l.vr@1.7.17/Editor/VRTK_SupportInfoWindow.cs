        ...
        private void RefreshData()
        {
            ...
            Append(
                ...
                () =>
                {
                    ...
                    {
                        FieldInfo currentVersionField = steamVRUpdateType.GetField("currentVersion",
                    ...
                    if (ovrPluginType != null)
                    {
                        Append(
                            ...
                            () =>
                            {
                                FieldInfo wrapperVersionField = ovrPluginType.GetField("wrapperVersion",
                                ...
                                PropertyInfo versionField = ovrPluginType.GetProperty("version",
                                    BindingFlags.Public | BindingFlags.Static);
                                ...
                                PropertyInfo nativeSDKVersionField = ovrPluginType.GetProperty("nativeSDKVersion",
                                    BindingFlags.Public | BindingFlags.Static);
                                if (nativeSDKVersionField != null)
                                {
                                    Version nativeSDKVersion =
                                        (Version) nativeSDKVersionField.GetGetMethod().Invoke(null, null);
...
#if UNITY_5_5_OR_NEWER
                        vrEnabledDevices = XRSettings.supportedDevices;
                    ...
                    foreach (BuildTargetGroup targetGroup in VRTK_SharedMethods.GetValidBuildTargetGroups())
                    {
                        string symbols = string.Join(
                            ...
                            PlayerSettings.GetScriptingDefineSymbolsForGroup(targetGroup)
                                .Split(';')
                                .Where(symbol => !symbol.StartsWith(VRTK_Defines.VersionScriptingDefineSymbolPrefix,
